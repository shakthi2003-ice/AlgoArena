...
export default function AddProblem() {
  ...
  return (
    <div style={{backgroundColor: "#B6EADA"}}>
      <div className="max-w-4xl mx-auto font-mono my-4">
        ...
        <div className="mt-8 space-y-8">
          <div className="flex">
            <h4 className="w-48 min-w-fit">Problem Slug</h4>
            <input
          ...
          <div className="flex">
            <h4 className="w-48 min-w-fit">Problem Name</h4>
            <input
          ...
          <div className="flex items-start">
            <h4 className="w-48 min-w-fit">Description</h4>
            <textarea
          ...
          <div className="flex items-start">
            <h4 className="w-48 min-w-fit">Difficulty</h4>
            <textarea
          ...
          <div className="flex items-start">
            <h4 className="w-48 min-w-fit">Provide a Tag for your Problem</h4>
            <textarea
              value={problemDetail.tags}
              onChange={(e) =>
                setProblemDetail({ ...problemDetail, tags: e.target.value })
              }
              rows={1}
              required
              className="flex-grow outline-none border-2 border-gray-400 p-2 rounded-sm shadow"
